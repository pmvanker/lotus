...
Adafruit_MQTT_Subscribe ssid = Adafruit_MQTT_Subscribe(&mqtt, "ssid");
Adafruit_MQTT_Subscribe psw = Adafruit_MQTT_Subscribe(&mqtt, "psw");
...
void loop() {
  ...
  while ((subscription = mqtt.readSubscription(5000))) 
  {
    ...
    else if (subscription == &ssid) {
      strcpy(wifi_ssid,(char *)ssid.lastread);
      Serial.println("MSG@NEW_SSID;");
    }
    else if (subscription == &psw) {
      strcpy(wifi_psw,(char *)psw.lastread);
      Serial.println("MSG@PASWORD;");
    }
  }
